...
import os
os.chdir('/home/dqw_cyy/11_MFDF_code/1_original_data/E')
...
with open('/home/dqw_cyy/11_MFDF_code/9_y_pred/6.1_E_MFDF_rf1xgb1rf1.csv', 'wb') as f:
...
with open('/home/dqw_cyy/11_MFDF_code/9_y_pred/6.1_E_MFDF_rf1xgb2rf1.csv', 'wb') as f:
    wr = csv.writer(f, quoting=csv.QUOTE_ALL)
...
with open('/home/dqw_cyy/11_MFDF_code/9_y_pred/6.1_E_MFDF_rf2xgb2rf2.csv', 'wb') as f:
    wr = csv.writer(f, quoting=csv.QUOTE_ALL)
    wr.writerow(['Each_row: 1.mode; 2.layer; 3.aupr; 4.auc; 5.y(mode,seed,cv,y_#5)'])
    wr.writerow(mode_list)
    wr.writerow(layer)
