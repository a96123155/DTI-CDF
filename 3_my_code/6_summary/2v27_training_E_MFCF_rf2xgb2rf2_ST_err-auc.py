...
labels = pd.read_csv('/home/dqw_cyy/11_MFDF_code/4_v2_generate_dataset/E/E_labels.csv')
...
def gain_results(seeds,mode,labels,learning_rate,max_depth,no_trees,criterion,layer):
    ...
    for seed in seeds:
        ...
        file_seq_folddata = glob.glob('/home/dqw_cyy/11_MFDF_code/4_v2_generate_dataset/E/E_folddata_S' + str(mode) + '_seed' + str(seed) + '_fold*' + '.csv')
        file_seq_testidx = glob.glob('/home/dqw_cyy/11_MFDF_code/4_v2_generate_dataset/E/E_testidx_S' + str(mode) + '_seed' + str(seed) + '_fold*' + '.csv')
...
with open('/home/dqw_cyy/11_MFDF_code/9_y_pred/E/027_summary__E_MFCF_rf2xgb2rf2_ST-err_auc.csv', 'wb') as f:
