...
import os
os.chdir('/home/yanyichu/11_MFDF_code/1_original_data/E')
...
protein_psepssm_file = pd.read_csv('/home/yanyichu/11_MFDF_code/2_feature/E/e_psepssm.csv')
molecule_fp2_file = pd.read_csv('/home/yanyichu/11_MFDF_code/2_feature/E/E_fp2.csv')
...
R_all_train_test = "E_combine_origin_new_interactions.txt"
...
labels = mat2vec(DT)
pd.DataFrame(labels).to_csv('/home/yanyichu/11_MFDF_code/4_generate_dataset/E/E_labels.csv', index = False)
...
for mode in mode_list:
    ...
    for seed in seeds:
        ...
        for fold_data,test_idx_fold in zip(folds_features,test_idx):
            pd.DataFrame(fold_data).to_csv('/home/yanyichu/11_MFDF_code/4_generate_dataset/E/E_folddata_S' + str(mode) + '_seed' + str(seed) + '_fold' + str(i) + '.csv',index = False)
            pd.DataFrame(test_idx_fold).to_csv('/home/yanyichu/11_MFDF_code/4_generate_dataset/E/E_testidx_S' + str(mode) + '_seed' + str(seed) + '_fold' + str(i) + '.csv', index = False)
            i += 1
