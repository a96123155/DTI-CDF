...
import os
os.chdir('/data/dqw_cjy/11_MFDF_code/1_original_data/NR')
...
labels = pd.read_csv('/data/dqw_cjy/11_MFDF_code/4_generate_dataset/NR/NR_labels.csv')
...
def gain_results(seeds,mode,labels,learning_rate,max_depth,no_trees,criterion,layer):
    ...
    for seed in seeds:
        ...
        file_seq_folddata = glob.glob('/data/dqw_cjy/11_MFDF_code/4_generate_dataset/NR/NR_folddata_S' + str(mode) + '_seed' + str(seed) + '_fold*' + '.csv')
        file_seq_testidx = glob.glob('/data/dqw_cjy/11_MFDF_code/4_generate_dataset/NR/NR_testidx_S' + str(mode) + '_seed' + str(seed) + '_fold*' + '.csv')
