...
import os
os.chdir('/lustre/home/acct-clsdqw/clsdqw-tahir/dqw_cyy/11_MFDF_code/1_original_data/IC')
...
labels = pd.read_csv('/lustre/home/acct-clsdqw/clsdqw-tahir/dqw_cyy/11_MFDF_code/4_generate_dataset_DDR/IC/IC_DDR_labels.csv')
...
def gain_results(seeds,mode,labels,learning_rate,max_depth,no_trees,criterion,layer):
    ...
    for seed in seeds:
        ...
        file_seq_folddata = glob.glob('/lustre/home/acct-clsdqw/clsdqw-tahir/dqw_cyy/11_MFDF_code/4_generate_dataset_DDR/IC/IC_DDR_folddata_S' + str(mode) + '_seed' + str(seed) + '_fold*' + '.csv')
        file_seq_testidx = glob.glob('/lustre/home/acct-clsdqw/clsdqw-tahir/dqw_cyy/11_MFDF_code/4_generate_dataset_DDR/IC/IC_DDR_testidx_S' + str(mode) + '_seed' + str(seed) + '_fold*' + '.csv')
...
model_architecture = ['rf2','rf2xgb2rf2']
...
os.chdir('/lustre/home/acct-clsdqw/clsdqw-tahir/dqw_cyy/11_MFDF_code/1_original_data/IC')
labels = pd.read_csv('/lustre/home/acct-clsdqw/clsdqw-tahir/dqw_cyy/11_MFDF_code/4_generate_dataset/IC/IC_labels.csv')
labels = np.array(labels['0'])
def gain_results(seeds,mode,labels,learning_rate,max_depth,no_trees,criterion,layer):
    trails_AUPRs = []
    trails_AUCs = []
    ...
    for seed in seeds:
        ...
        file_seq_folddata = glob.glob('/lustre/home/acct-clsdqw/clsdqw-tahir/dqw_cyy/11_MFDF_code/4_generate_dataset/IC/IC_folddata_S' + str(mode) + '_seed' + str(seed) + '_fold*' + '.csv')
        file_seq_testidx = glob.glob('/lustre/home/acct-clsdqw/clsdqw-tahir/dqw_cyy/11_MFDF_code/4_generate_dataset/IC/IC_testidx_S' + str(mode) + '_seed' + str(seed) + '_fold*' + '.csv')
