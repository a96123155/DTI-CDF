...
from scipy.signals.signaltools import correlate
from signal import signal
from signal import alarm
import time
...
def corr_results(data, mode = 'p'):
    ...
    #R_xx,R_yy
    mse_PathCS = correlate(data_PathCS,data_PathCS, mode = 'valid')[0]
#    mse_FP2 = (data_FP2 ** 2).sum() / len(data_FP2)
    mse_PsePSSM = correlate(data_PsePSSM,data_PsePSSM, mode = 'valid')[0]
    
    #R_xy
    R_PathCS_vs_FP2 = (correlate(data_PathCS,data_FP2, mode = 'valid') / len(data_PathCS))
    R_PathCS_vs_PsePSSM = (correlate(data_PathCS,data_PsePSSM, mode = 'valid') / len(data_PathCS))
    R_PsePSSM_vs_FP2 = (correlate(data_PsePSSM,data_FP2, mode = 'valid') / len(data_PsePSSM))
    ...
    for i in range(len(R_PathCS_vs_FP2)):
        try:
            ...
            R_FP2 = correlate(y_FP2,y_FP2, mode = 'valid')[0]
    ...
    for i in range(len(R_PathCS_vs_PsePSSM)):
        try:
            ...
            R_PsePSSM = correlate(y_PsePSSM,y_PsePSSM, mode = 'valid')[0]
...
def draw_corr_matrice(corr_matrice, dataset = 'NR', mode = 'p'):
    ...
    plt.savefig('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/' + dataset + '/' + dataset + '_S' + mode + '_corr_matrice_(2).png', dpi = 300)
    #plt.show()
    return 
...
#NR_Sp_mean_data = pd.read_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/5.4_mean_NR_folddata_Sp.csv',index_col = 0)
...
## In[27]:
#
#NR_SD_mean_data = pd.read_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/5.4_mean_NR_folddata_SD.csv',index_col = 0)
...
## In[28]:
#
#NR_ST_mean_data = pd.read_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/5.4_mean_NR_folddata_ST.csv',index_col = 0)
...
## In[22]:
print('=====================GCPR_SP====================================')
GPCR_Sp_mean_data = pd.read_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/5.4_mean_GPCR_folddata_Sp.csv',index_col = 0)
...
# In[23]:
print('=====================GCPR_SD====================================')
GPCR_SD_mean_data = pd.read_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/5.4_mean_GPCR_folddata_SD.csv',index_col = 0)
...
# In[24]:
print('=====================GCPR_ST====================================')
GPCR_ST_mean_data = pd.read_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/5.4_mean_GPCR_folddata_ST.csv',index_col = 0)
...
## In[26]:
#print('====================================IC_ST========================')
#IC_ST_mean_data = pd.read_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/5.4_mean_IC_folddata_ST.csv',index_col = 0)
...
## In[27]:
#print('====================================IC_SD========================')
#IC_SD_mean_data = pd.read_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/5.4_mean_IC_folddata_SD.csv',index_col = 0)
...
## In[28]:
#print('====================================IC_SP========================')
#IC_Sp_mean_data = pd.read_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/5.4_mean_IC_folddata_Sp.csv',index_col = 0)
...
## In[29]:
#print('====================================E_ST========================')
#E_ST_mean_data = pd.read_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/5.4_mean_E_folddata_ST.csv',index_col = 0)
...
## In[30]:
#print('====================================E_SD========================')
#E_SD_mean_data = pd.read_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/5.4_mean_E_folddata_SD.csv',index_col = 0)
...
## In[31]:
#print('====================================E_SP========================')
#E_Sp_mean_data = pd.read_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/5.4_mean_E_folddata_Sp.csv',index_col = 0)
...
#corr_ST_matrice.to_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/NR_ST_corr_matrice.csv')
#corr_SD_matrice.to_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/NR_SD_corr_matrice.csv')
#corr_Sp_matrice.to_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/NR_Sp_corr_matrice.csv')
GPCR_corr_ST_matrice.to_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/GPCR_ST_corr_matrice.csv')
GPCR_corr_SD_matrice.to_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/GPCR_SD_corr_matrice.csv')
GPCR_corr_Sp_matrice.to_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/GPCR_Sp_corr_matrice.csv')
#IC_corr_ST_matrice.to_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/IC_ST_corr_matrice.csv')
#IC_corr_SD_matrice.to_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/IC_SD_corr_matrice.csv')
#IC_corr_Sp_matrice.to_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/IC_Sp_corr_matrice.csv')
#
#
## In[ ]:
#
#E_corr_ST_matrice.to_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/E_ST_corr_matrice.csv')
#E_corr_SD_matrice.to_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/E_SD_corr_matrice.csv')
#E_corr_Sp_matrice.to_csv('/data/dqw_cjy/11_MFDF_code/5_feature_analysis/E_Sp_corr_matrice.csv')
