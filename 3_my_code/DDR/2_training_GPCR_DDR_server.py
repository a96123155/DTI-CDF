...
labels = pd.read_csv('/home/yanyichu/11_MFDF_code/4_generate_dataset_DDR/GPCR/GPCR_DDR_labels.csv')
...
def gain_results(seeds,mode,labels,learning_rate,max_depth,no_trees,criterion,layer):
    ...
    for seed in seeds:
        ...
        file_seq_folddata = glob.glob('/home/yanyichu/11_MFDF_code/4_generate_dataset_DDR/GPCR/GPCR_DDR_folddata_S' + str(mode) + '_seed' + str(seed) + '_fold*' + '.csv')
        file_seq_testidx = glob.glob('/home/yanyichu/11_MFDF_code/4_generate_dataset_DDR/GPCR/GPCR_DDR_testidx_S' + str(mode) + '_seed' + str(seed) + '_fold*' + '.csv')
...
model_architecture = ['rfxgb2rf','rf2','xgb2','xgb3','rf3','rf2xgb2rf2']
