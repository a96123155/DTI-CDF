...
#import os
#os.chdir(r'E:\12_github_1\DTI-CDF\2_Example_NR')
...
def calc_metrics(y_results,DT_feature_pair_list):
    all_fp, all_fn = [],[]
    all_tp, all_tn = [],[]
    ...
    return DTI_CDF_new_pair, y_choose_all
...
def run_classification(mode, seed, X_train_10_fold, X_test_10_fold, y_train_10_fold, y_test_10_fold,test_idx_10_fold, train_idx_10_fold, layer):   
    ...
    if mode == 'p':
        xgb_param = {}
        xgb_param[1231] = {'xgb_max_depth':4, 'min_child_weight':0.1, 'lr':0.5, 'xgb_tree':150,
                           'xgb_max_depth_2':4, 'min_child_weight_2':0.01, 'lr_2':0.1, 'xgb_tree_2':500}
        xgb_param[8367] = {'xgb_max_depth':6, 'min_child_weight':0.1, 'lr':0.1, 'xgb_tree':100,
                           'xgb_max_depth_2':8, 'min_child_weight_2':0.01, 'lr_2':0.1, 'xgb_tree_2':600}
        xgb_param[22]   = {'xgb_max_depth':8, 'min_child_weight':0.1, 'lr':0.5, 'xgb_tree':100,
                           'xgb_max_depth_2':7, 'min_child_weight_2':0.1, 'lr_2':0.1, 'xgb_tree_2':300}
        xgb_param[1812] = {'xgb_max_depth':3, 'min_child_weight':0.1, 'lr':0.1, 'xgb_tree':200,
                           'xgb_max_depth_2':3, 'min_child_weight_2':0.01, 'lr_2':0.1, 'xgb_tree_2':150}
        xgb_param[4659] = {'xgb_max_depth':6, 'min_child_weight':0.1, 'lr':0.1, 'xgb_tree':200,
                           'xgb_max_depth_2':6, 'min_child_weight_2':1, 'lr_2':0.1, 'xgb_tree_2':250}
        
        rf_param = {}
        rf_param[1231] = {'rf_tree':200, 'rf_max_depth':3, 'rf_tree_2':100, 'rf_max_depth_2':10}
        rf_param[8367] = {'rf_tree':200, 'rf_max_depth':3, 'rf_tree_2':100, 'rf_max_depth_2':10}                   
        rf_param[22]   = {'rf_tree':200, 'rf_max_depth':3, 'rf_tree_2':100, 'rf_max_depth_2':10}                   
        rf_param[1812] = {'rf_tree':200, 'rf_max_depth':3, 'rf_tree_2':100, 'rf_max_depth_2':10}                   
        rf_param[4659] = {'rf_tree':200, 'rf_max_depth':3, 'rf_tree_2':100, 'rf_max_depth_2':10}
                         
        
    elif mode == 'D':    
        xgb_param = {}
        xgb_param[1231] = {'xgb_max_depth':3, 'min_child_weight':0.001, 'lr':0.01, 'xgb_tree':200,
                           'xgb_max_depth_2':3, 'min_child_weight_2':0.1, 'lr_2':0.01, 'xgb_tree_2':200}
        xgb_param[8367] = {'xgb_max_depth':3, 'min_child_weight':1, 'lr':0.01, 'xgb_tree':800,
                           'xgb_max_depth_2':9, 'min_child_weight_2':0.001, 'lr_2':0.1, 'xgb_tree_2':100}
        xgb_param[22]   = {'xgb_max_depth':3, 'min_child_weight':0.001, 'lr':0.01, 'xgb_tree':500,
                           'xgb_max_depth_2':3, 'min_child_weight_2':0.01, 'lr_2':0.01, 'xgb_tree_2':500}
        xgb_param[1812] = {'xgb_max_depth':3, 'min_child_weight':1, 'lr':0.01, 'xgb_tree':200,
                           'xgb_max_depth_2':6, 'min_child_weight_2':0.1, 'lr_2':0.01, 'xgb_tree_2':800}
        xgb_param[4659] = {'xgb_max_depth':3, 'min_child_weight':0.001, 'lr':0.01, 'xgb_tree':200,
                           'xgb_max_depth_2':3, 'min_child_weight_2':0.001, 'lr_2':0.01, 'xgb_tree_2':250}
        ...
        xgb_param = {}
        xgb_param[1231] = {'xgb_max_depth':3, 'min_child_weight':0.1, 'lr':0.5, 'xgb_tree':100,
                           'xgb_max_depth_2':3, 'min_child_weight_2':0.1, 'lr_2':0.5, 'xgb_tree_2':250}
        xgb_param[8367] = {'xgb_max_depth':4, 'min_child_weight':0.001, 'lr':0.1, 'xgb_tree':800,
                           'xgb_max_depth_2':4, 'min_child_weight_2':0.001, 'lr_2':0.3, 'xgb_tree_2':100}
        xgb_param[22]   = {'xgb_max_depth':9, 'min_child_weight':0.001, 'lr':0.5, 'xgb_tree':800,
                           'xgb_max_depth_2':9, 'min_child_weight_2':0.001, 'lr_2':0.5, 'xgb_tree_2':600}
        xgb_param[1812] = {'xgb_max_depth':3, 'min_child_weight':0.1, 'lr':0.1, 'xgb_tree':300,
                           'xgb_max_depth_2':4, 'min_child_weight_2':1, 'lr_2':0.01, 'xgb_tree_2':800}
        xgb_param[4659] = {'xgb_max_depth':4, 'min_child_weight':0.001, 'lr':0.1, 'xgb_tree':250,
                           'xgb_max_depth_2':4, 'min_child_weight_2':0.001, 'lr_2':0.1, 'xgb_tree_2':200}
...
def gain_results(seeds, mode_list, layer, only_PathCS_feature = False):
    ...
    for mode in mode_list:
        ...
        for seed in seeds:
            ...
            filename = r'NR_folddata_X-Y_S' + str(mode) + '_seed' + str(seed) + '.npz'
...
def run_classification_configuration(X_train_10_fold, X_test_10_fold, y_train_10_fold, y_test_10_fold,test_idx_10_fold, train_idx_10_fold,
    ...
    return [Avg_AUPR_training, Avg_AUPR_testing, folds_AUPR_testing,  #012
            ...
            folds_recall_25, folds_recall_50, folds_G_mean], [test_true_predict_compare, train_true_predict_compare] #folds_recall_100, folds_recall_200, folds_recall_400,
...
model_architecture = ['rf2', 'xgb2']#['rf1xgb1', 'rf2', 'xgb2', 'rf2xgb2', 'rf1xgb2', 'rf2xgb1']
...
for layer in model_architecture:
    ...
    DTI_CDF_new_pair, y_choose_all = calc_metrics(rf1_PathCS_test_true_predict_compare_10cv_seeds_modes,DT_feature_pair_list)
    time_end_wall = time.time()
    print('Time = {}'.format(time_end_wall - time_begin_wall))
