...
import os
os.chdir(r'E:\11_MFDF_code\1_original_data\GPCR')
...
with open(r'E:\11_MFDF_code\1_original_data\GPCR\GPCR_combine_origin_new_interactions.txt','r') as f:
    GPCR_ddr_new_pair = f.readlines()
GPCR_ddr_new_pair = [item.replace('\n','').split('\t') for item in GPCR_ddr_new_pair]
GPCR_ddr_new_pair = [item[0] + ',' + item[1] for item in GPCR_ddr_new_pair]
#-------------------------

R_all_train_test = "GPCR_admat_dgc_mat_2_line.txt"
...
def calc_metrics(y_results,DT_feature_pair_list,GPCR_ddr_new_pair):
    all_fp, all_fn = [],[]
    all_tp, all_tn = [],[]
    ...
    ddr_intersection_dti = list(set(DTI_CDF_new_pair).intersection(set(GPCR_ddr_new_pair)))
...
def run_classification(mode, seed, X_train_10_fold, X_test_10_fold, y_train_10_fold, y_test_10_fold,test_idx_10_fold, train_idx_10_fold, layer):   
    ...
    if mode == 'p':
        xgb_param = {}
        xgb_param[1231] = {'xgb_max_depth':6, 'min_child_weight':0.1, 'lr':0.1, 'xgb_tree':200,
                           'xgb_max_depth_2':7, 'min_child_weight_2':1, 'lr_2':0.1, 'xgb_tree_2':200}
        xgb_param[8367] = {'xgb_max_depth':7, 'min_child_weight':0.1, 'lr':0.1, 'xgb_tree':250,
                           'xgb_max_depth_2':7, 'min_child_weight_2':0.01, 'lr_2':0.1, 'xgb_tree_2':250}
        xgb_param[22]   = {'xgb_max_depth':4, 'min_child_weight':0.001, 'lr':0.1, 'xgb_tree':300,
                           'xgb_max_depth_2':5, 'min_child_weight_2':0.1, 'lr_2':0.1, 'xgb_tree_2':300}
        xgb_param[1812] = {'xgb_max_depth':6, 'min_child_weight':0.01, 'lr':0.1, 'xgb_tree':600,
                           'xgb_max_depth_2':5, 'min_child_weight_2':0.001, 'lr_2':0.1, 'xgb_tree_2':300}
        xgb_param[4659] = {'xgb_max_depth':9, 'min_child_weight':1, 'lr':0.1, 'xgb_tree':150,
                           'xgb_max_depth_2':5, 'min_child_weight_2':0.01, 'lr_2':0.1, 'xgb_tree_2':300}
        
        rf_param = {}
        rf_param[1231] = {'rf_tree':100, 'rf_max_depth':3, 'rf_tree_2':300, 'rf_max_depth_2':None}
        rf_param[8367] = {'rf_tree':100, 'rf_max_depth':3, 'rf_tree_2':100, 'rf_max_depth_2':None}                   
        rf_param[22]   = {'rf_tree':100, 'rf_max_depth':3, 'rf_tree_2':500, 'rf_max_depth_2':20}                   
        rf_param[1812] = {'rf_tree':100, 'rf_max_depth':3, 'rf_tree_2':300, 'rf_max_depth_2':None}                   
        rf_param[4659] = {'rf_tree':100, 'rf_max_depth':3, 'rf_tree_2':500, 'rf_max_depth_2':30}
                         
        
    elif mode == 'D':    
        xgb_param = {}
        xgb_param[1231] = {'xgb_max_depth':4, 'min_child_weight':0.01, 'lr':0.1, 'xgb_tree':100,
                           'xgb_max_depth_2':4, 'min_child_weight_2':0.001, 'lr_2':0.1, 'xgb_tree_2':150}
        xgb_param[8367] = {'xgb_max_depth':5, 'min_child_weight':0.001, 'lr':0.1, 'xgb_tree':150,
                           'xgb_max_depth_2':4, 'min_child_weight_2':0.1, 'lr_2':0.1, 'xgb_tree_2':200}
        xgb_param[22]   = {'xgb_max_depth':3, 'min_child_weight':0.01, 'lr':0.1, 'xgb_tree':200,
                           'xgb_max_depth_2':3, 'min_child_weight_2':1, 'lr_2':0.1, 'xgb_tree_2':150}
        xgb_param[1812] = {'xgb_max_depth':4, 'min_child_weight':0.1, 'lr':0.1, 'xgb_tree':200,
                           'xgb_max_depth_2':6, 'min_child_weight_2':0.01, 'lr_2':0.1, 'xgb_tree_2':150}
        xgb_param[4659] = {'xgb_max_depth':3, 'min_child_weight':0.001, 'lr':0.1, 'xgb_tree':200,
                           'xgb_max_depth_2':3, 'min_child_weight_2':0.1, 'lr_2':0.1, 'xgb_tree_2':250}
        
        rf_param = {}
        rf_param[1231] = {'rf_tree':100, 'rf_max_depth':3, 'rf_tree_2':100, 'rf_max_depth_2':20}
        rf_param[8367] = {'rf_tree':200, 'rf_max_depth':3, 'rf_tree_2':100, 'rf_max_depth_2':30}                      
        rf_param[22]   = {'rf_tree':100, 'rf_max_depth':3, 'rf_tree_2':100, 'rf_max_depth_2':8}                      
        rf_param[1812] = {'rf_tree':100, 'rf_max_depth':3, 'rf_tree_2':500, 'rf_max_depth_2':10}                      
        rf_param[4659] = {'rf_tree':100, 'rf_max_depth':3, 'rf_tree_2':300, 'rf_max_depth_2':5}

    elif mode == 'T':    
        xgb_param = {}
        xgb_param[1231] = {'xgb_max_depth':10, 'min_child_weight':0.01, 'lr':0.01, 'xgb_tree':800,
                           'xgb_max_depth_2':7, 'min_child_weight_2':0.1, 'lr_2':0.1, 'xgb_tree_2':150}
        xgb_param[8367] = {'xgb_max_depth':5, 'min_child_weight':0.1, 'lr':0.1, 'xgb_tree':250,
                           'xgb_max_depth_2':6, 'min_child_weight_2':0.01, 'lr_2':0.1, 'xgb_tree_2':500}
        xgb_param[22]   = {'xgb_max_depth':8, 'min_child_weight':0.01, 'lr':0.01, 'xgb_tree':800,
                           'xgb_max_depth_2':7, 'min_child_weight_2':0.1, 'lr_2':0.1, 'xgb_tree_2':100}
        xgb_param[1812] = {'xgb_max_depth':10, 'min_child_weight':0.01, 'lr':0.1, 'xgb_tree':300,
                           'xgb_max_depth_2':10, 'min_child_weight_2':0.1, 'lr_2':0.5, 'xgb_tree_2':100}
        xgb_param[4659] = {'xgb_max_depth':8, 'min_child_weight':1, 'lr':0.01, 'xgb_tree':800,
                           'xgb_max_depth_2':6, 'min_child_weight_2':1, 'lr_2':0.1, 'xgb_tree_2':200}
    
        rf_param = {}
        rf_param[1231] = {'rf_tree':400, 'rf_max_depth':3, 'rf_tree_2':500, 'rf_max_depth_2':30}
        rf_param[8367] = {'rf_tree':200, 'rf_max_depth':3, 'rf_tree_2':200, 'rf_max_depth_2':30}                    
        rf_param[22]   = {'rf_tree':200, 'rf_max_depth':3, 'rf_tree_2':500, 'rf_max_depth_2':20}                    
        rf_param[1812] = {'rf_tree':500, 'rf_max_depth':3, 'rf_tree_2':500, 'rf_max_depth_2':30}                    
        rf_param[4659] = {'rf_tree':100, 'rf_max_depth':3, 'rf_tree_2':200, 'rf_max_depth_2':30}
...
def gain_results(seeds, mode_list, layer, only_PathCS_feature = False):
    ...
    for mode in mode_list:
        ...
        for seed in seeds:
            ...
            filename = r'E:\11_MFDF_code\3_my_code\9_major_revised\GPCR\data\GPCR_folddata_X-Y_S' + str(mode) + '_seed' + str(seed) + '.npz'
...
DTI_CDF_new_pair, y_choose_all, ddr_intersection_dti = calc_metrics(rf1_PathCS_test_true_predict_compare_10cv_seeds_modes,DT_feature_pair_list,GPCR_ddr_new_pair)
...
mode_list = ["p","D","T"]
seeds = [1231, 8367, 22, 1812, 4659]
model_architecture = ['rf2xgb1', 'rf1xgb2']
